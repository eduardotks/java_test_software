...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "Eduardo Tk", 30, "eduardo@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Tony Stk", 44, "tonyst@gmail.com", conta02.getId(), true);
